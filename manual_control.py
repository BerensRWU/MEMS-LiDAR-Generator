...
import re
import weakref
from mems_class import MEMS_Sensor
...
class World(object):
    ...
    def destroy(self):
        if self.mems_sensor is not None:
            self.toggle_MEMS()
        sensors = [
...
class CameraManager(object):
    def __init__(self, parent_actor, hud):
        ...
        self._camera_transforms = [
            (carla.Transform(carla.Location(x=-3.5, z=2.5)), Attachment.Rigid)]
